...
export const profiles: Record<ProfileSubtype, DigitalProfile> = {
  'social-light': {
    ...
    digitalTendency:
      '혼자 있는 시간이 자연스럽고, 연결은 필요할 때만 선택하는 흐름이에요.',
    keyTraits: [
      '혼자 있는 시간이 더 편한 편',
      '연결은 적지만 깊게 이어지는 스타일',
      '관계의 양보다 질을 중요하게 생각함',
    ...
    behaviorPattern:
      '아침에는 알림보다 다른 일을 먼저 보고, 필요할 때만 메시지를 확인하는 흐름이에요. 단체보다는 1:1 대화를 더 편하게 느끼는 편입니다.',
    recommendedLifestyle:
      '하루 중 짧게라도 연결 시간을 정해두면 관계가 더 편안해질 수 있어요.',
    caution:
      '연결이 너무 적어지면 거리감이 생길 수 있어요. 가벼운 안부가 도움이 됩니다.',
    summary: '가볍게 머물지만 오래 이어지는 관계 스타일',
    color: '#d4a574',
    emoji: '🌤️',
  },
  ...
  'social-heavy': {
    ...
    digitalTendency:
      '연결 중심의 디지털 사용이 일상 전반에 걸쳐 이어지는 흐름이에요.',
    keyTraits: [
      '메시지 반응이 빠른 편',
      '관계 중심의 디지털 사용',
      '연결이 에너지의 중요한 원천',
